...
const connectionData = [
  { from: 0, to: 3, distance: 0.9, oneWay: false },
  { from: 3, to: 2, distance: 1.0, oneWay: false },
  { from: 4, to: 7, distance: 1.0, oneWay: false },
  { from: 3, to: 8, distance: 0.5, oneWay: false },
  { from: 8, to: 4, distance: 0.6, oneWay: true },
  { from: 2, to: 8, distance: 0.85, oneWay: true },
  { from: 1, to: 2, distance: 0.8, oneWay: true },
  { from: 10, to: 5, distance: 0.55, oneWay: true },
  { from: 5, to: 1, distance: 0.35, oneWay: false },
  { from: 9, to: 10, distance: 0.55, oneWay: false },
  { from: 9, to: 5, distance: 0.3, oneWay: false },
  { from: 4, to: 9, distance: 0.75, oneWay: false },
  { from: 3, to: 7, distance: 1.05, oneWay: true },
  { from: 0, to: 6, distance: 4.2, oneWay: false },
  { from: 6, to: 3, distance: 3.7, oneWay: false },
  { from: 4, to: 2, distance: 0.9, oneWay: true }
];
...
function displayResults(path, totalCost, executionTime) {
  document.getElementById("timeOutput").textContent = executionTime.toFixed(3);
